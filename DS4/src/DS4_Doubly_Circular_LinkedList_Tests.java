...
public class DS4_Doubly_Circular_LinkedList_Tests {
    ...
    public void test1() throws Exception {
        ...
        try
        {
            Class<?> ll = Class.forName(generateClassName("DS4_Doubly_Circular_LinkedList"));
            ...
            Class<?> lln = Class.forName(generateClassName("DS4_Doubly_Circular_LinkedList_Node"));
            ...
            linkageCheck(correct,getFirstNode.invoke(check),getLastNode.invoke(check));
        }
    ...
    public void linkageCheck(ArrayList<Integer> correct, Object first,Object last) throws Exception
    {
        if(correct.size()!=0)
        {
            //Forward Checks
            ...
            for(int x=correct.size()-1; x>=0; x--)
            {
                Assert.assertEquals(correct.get(x),getData.invoke(cur));
                cur = (Object)getPrev.invoke(cur);
            }
